...
net_arg.add_argument('--output_dim', type=int, default=7, help='number of classes')
...
data_arg.add_argument('--task', type=str, default='s2l')
...
train_arg.add_argument('--lr_start', type=float, default=0.00005, help='')
